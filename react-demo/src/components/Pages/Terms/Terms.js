...
export default function Terms() {
  useEffect(() => {
    ...
    return (
      <div className="mainContainerTerms">
        ...
        <div>
          <h5>OVERVIEW's</h5>
          <p>
            This website is operated by Dhullo Car Care. Throughout the site,
            the terms “we”, “us” and “our” refer to Dhullo Car Care. Dhullo Car
            Care offers this website, including all information, tools and
        ...
        <div>
          ...
          <p>
            ...
            Dhullo Car Care, our directors, officers, employees, affiliates,
        ...
        <div>
          ...
          <p>
            You agree to indemnify, defend and hold harmless Dhullo Car Care and
